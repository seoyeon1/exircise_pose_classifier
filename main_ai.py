...
joint_list = {'Push_up' : [[11,13,15] , [11,23,25]],
             ...
             'L_fly' : [[11,13,15], [14,12,11], [12,14,16], [13,11,23]],
...
def vod1_start():
    ...
    cfile = cv2.VideoCapture(0)  # 노트북카메라 : 0, USB 카메라 : 1
    ...
    with mp_holistic.Holistic(min_detection_confidence=0.8, min_tracking_confidence=0.8) as holistic:
        while True:
            ...
            frame_v = cv2.resize(frame_v ,dsize=(760,800), interpolation=cv2.INTER_AREA) 
            frame_c = cv2.resize(frame_c ,dsize=(760,800), interpolation=cv2.INTER_AREA) 
                    ...
                    # Curl Counter 구현
                        ...
                        if fitness_pose_class == 'Push_up':
                            ...
                            if angles[0] >160 and angles[1]>160: 
                                stat = 'ready'
                            if stat == 'ready' and 120<angles[2]<150 or 120<angles[3]<150:
                                pygame.mixer.music.load('down.mp3')
                                pygame.mixer.music.play()
                            if angles[0]<120 and angles[1]<120 and stat == 'ready':
                                stat = 'lunge'
                                counter +=1
                                # print(counter)
                                pygame.mixer.music.load('ok.mp3')
                            ...
                            if angles[0] > 160 and angles[1] > 160:
                                stat = 'ready'
                            if stat=='ready' and 120 > angles[0] > 90 and 120 > angles[1] > 90:
                                pygame.mixer.music.load('down.mp3')
                                pygame.mixer.music.play()
                            if angles[0] < 90 and angles[1] < 90 and stat == 'ready':
                                stat = 'squat'
                                counter += 1
                                # print(counter)
                                pygame.mixer.music.load('ok.mp3')
                ...
                try:
                    ...
                    # Curl Counter 구현
                        ...
                        if fitness_pose_class == 'Push_up':
                            ...
                            if angles[0] >160 and angles[1]>160: 
                                stat = 'ready'
                            if stat == 'ready' and angles[2]>100 or angles[3]>100:
                                pygame.mixer.music.load('down.mp3')
                                pygame.mixer.music.play()
                            if angles[0]<100 and angles[1]<100 and stat == 'ready':
                                stat = 'lunge'
                                counter +=1
                                # print(counter)
                                pygame.mixer.music.load('ok.mp3')
